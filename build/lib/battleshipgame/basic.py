...
def check_input(userinput):
    ...
    It returns the letters as a list, the string without blanks
...
def check_gridpoint(userinput_point):
    """
    This function cleans an input-string and checks
    whether it is a a point on the grid.
    """
    input_list, input_string, input_length = \
        check_input(userinput_point.upper())
