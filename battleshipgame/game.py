"""
This is the main file of the Battleship Game. It includes and initiates the Game-Class
"""
...
class Game:
    ...
    def get_players(self):
        """
        This gets the names of the players and prompts them to continue into the single player setup
        for both players.
        """
        clear_screen()
        ...
        input('Great {} and {}! Press any key when you are ready to start the game.'.format(
    ...
    def get_turn(self, player):
        """
        This prompts a player to take his turn. When he is ready, he hits any key, then the screen
        is cleared an his turn starts.
        """
        clear_screen()
    ...
    def __init__(self):
        """
        This initiates the game. It is over, when one of the players is defeated, meaning
        all his ships are sunk.
        """
        self.setup()
